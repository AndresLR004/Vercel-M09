...
export const PostGrid = ({v, deletePost} ) => {
  ...
  let usuari = JSON.parse(localStorage.getItem("user"))
  ...
  return (
    <div key={v.id } className="p-1 rounded-xl group sm:flex space-x-6 bg-white bg-opacity-50 shadow-xl hover:rounded-2xl">
          {/* <img src={ v.img } alt="art cover" loading="lazy" width="1000" height="667" className="h-56 sm:h-full w-full sm:w-5/12 object-cover object-top rounded-lg transition duration-500 group-hover:rounded-xl"/> */}
